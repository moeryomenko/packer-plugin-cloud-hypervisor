module github.com/moeryomenko/packer-plugin-cloud-hypervisor
...
// Fix gob encoding of cty.Type values in the plugin RPC protocol.
// See https://github.com/hashicorp/packer-plugin-sdk/issues/187
